...
@section('content')
    ...
    <div class="modal fade modalPengumuman" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
        <div class="modal-dialog modal-l">
            <div class="modal-content">
                <form action="{{ route('simpan-pengumuman') }}" method="POST" id="formPengumuman">
                    @csrf
                    <input type="hidden" name="id" id="id_save">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalFullscreenLabel">Data Pengumuman</h5>
                ...
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="hstack gap-2 justify-content-center">
                            <form action="{{ route('hapus-pengumuman') }}" method="POST">
                                @csrf
    ...
    @push("scripts")
        ...
        <script>
            ...
            function edit(id) {
                $('#formPengumuman')[0].reset();
                var url = "{{ route('show-pengumuman') }}" + "/" + id;
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.alert == '1') {
                            ...
                            $('#formPengumuman')[0].reset();
                            $('#formPengumuman').attr("action", "{{ route('simpan-pengumuman') }}");
